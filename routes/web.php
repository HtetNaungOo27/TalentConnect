...
/*
|--------------------------------------------------------------------------
| Job Search (IMPORTANT: Must Be Above Resource)
|--------------------------------------------------------------------------
*/
...
Route::resource('jobs', JobController::class)
    ->only(['index', 'show'])
    ->where(['job' => '[0-9]+']); // Prevents "search" conflict
...
Route::middleware('auth')->group(function () {
    ...
    */
    ...
    Route::middleware('role:employer')->group(function () {
        ...
        Route::patch('/applicants/{applicant}/status',
...
Route::middleware(['auth', 'role:admin'])->group(function () {
    ...
    Route::get('/admin/jobs/{job}',
        [AdminController::class, 'showJob']
    )->name('admin.jobs.show');

    Route::put('/admin/jobs/{job}/status',
        [AdminController::class, 'updateStatus']
    )->name('admin.jobs.status');

    Route::patch('/admin/jobs/{job}/reject',
        [AdminController::class, 'rejectJob']
